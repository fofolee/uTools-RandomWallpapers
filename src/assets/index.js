...
const baseConfig = {
  categories: {
    abstract: {
      name: "抽象",
      url: "https://alphacoders.com/abstract-wallpapers",
    },
    animal: { name: "动物", url: "https://alphacoders.com/animal-wallpapers" },
    anime: { name: "动漫", url: "https://alphacoders.com/anime-wallpapers" },
    artistic: {
      name: "艺术",
      url: "https://alphacoders.com/artistic-wallpapers",
    },
    celebrity: {
      name: "名人",
      url: "https://alphacoders.com/celebrity-wallpapers",
    },
    comic: { name: "漫画", url: "https://alphacoders.com/comic-wallpapers" },
    fantasy: {
      name: "奇幻",
      url: "https://alphacoders.com/fantasy-wallpapers",
    },
    food: { name: "美食", url: "https://alphacoders.com/food-wallpapers" },
    man_made: {
      name: "人造",
      url: "https://alphacoders.com/man-made-wallpapers",
    },
    ...
    photography: {
      name: "摄影",
      url: "https://alphacoders.com/photography-wallpapers",
    },
    sci_fi: { name: "科幻", url: "https://alphacoders.com/sci-fi-wallpapers" },
    sports: { name: "运动", url: "https://alphacoders.com/sports-wallpapers" },
    tv_show: {
      name: "电视节目",
      url: "https://alphacoders.com/tv-show-wallpapers",
    },
    vehicle: {
      name: "交通工具",
      url: "https://alphacoders.com/vehicle-wallpapers",
    },
    video_game: {
      name: "游戏",
      url: "https://alphacoders.com/video-game-wallpapers",
    },
  ...
  sorting: {
    ...
    newest_wallpapers: {
      name: "最近",
      url: "https://alphacoders.com/newest-wallpapers",
    },
    random: { name: "随机", url: "https://wall.alphacoders.com/random.php" },
    by_views: {
      name: "浏览量",
      url: "https://wall.alphacoders.com/by_views.php",
    },
    by_favorites: {
      name: "收藏量",
      url: "https://wall.alphacoders.com/by_favorites.php",
    },
    popular: {
      name: "近期排行",
      url: "https://alphacoders.com/popular-wallpapers",
    },
    by_category: {
      name: "按分类",
...
const parseHtmlResponse = (response) => {
  ...
  let doms = Array.from(
    response.querySelectorAll(".thumb-container,#container_thumbs_hidden .item")
  );
  console.log("doms:", doms);
  let result = doms
    .filter((dom) => dom.querySelector("picture"))
    .map((dom) => {
      let thumbs = {
        small: dom.querySelector("picture > :first-child").srcset,
  ...
  var result = await Swal.fire({
    ...
    onBeforeOpen: () => {
      ...
      showCustomScriptHelp = () => {
        Swal.fire({
          text: "你可以自定义一个脚本来用来替换本插件设置壁纸时所使用的命令，使用$file来表示壁纸的路径，例如：/home/xx/setWallpaper.sh $file",
        });
      };
      setCategoriesStatus = () => {
    ...
    preConfirm: async () => {
      ...
      data.customScript[utools.getLocalId()] =
        document.getElementById("customScript").value;
...
const autoChangeWallpaper = async () => {
  ...
  if (result.dismiss) {
    ...
    if (!parseInt(result.value))
      return toastMsg("请输入大于 0 的数值", "error");
...
const wallhavenSayByeBye = async () => {
  ...
  await Swal.fire({
    title: "壁纸源变更",
    text: "由于原壁纸源WallHaven发布td壁纸，已被国家重拳出击，故将壁纸源由WallHeaven改为Alphacoders，由于该网站已不可访问，本插件将自动备份当前的用户数据到桌面/utoolsRandomWallpaperDataBackup.json文件中，然后清除插件内收藏的壁纸（自动下载到本地的壁纸不会删除）",
  });
  window.saveFile(
    window.joinpath(
